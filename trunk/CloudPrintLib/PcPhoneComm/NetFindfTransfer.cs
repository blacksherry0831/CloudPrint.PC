   ...
   public class NetFindfTransfer
    {
      ...
      // public static readonly  int[] mTcpSetverPort=new int[]{10001,20002,30003};
        ...
        public static readonly int[] mUdpSetverPort = new int[] { 30003 };
        public static readonly int[] mTcpSetverPort = new int[] { 30003 };
        ...
        public NetFindfTransfer()
        {
            ...
            ThreadPool.SetMinThreads(30, 100);
...
**/
        public void UdpServerRecv()
        {
            ...
            client.Client.ReceiveBufferSize=20480;
...
**/
     public void InitImageList()
     {
         ...
         this.mImageList.Images.Add("1", CloudPrintLib.Properties.Resources.Computer);
         this.mImageList.Images.Add("2",CloudPrintLib.Properties.Resources.phone);
     }
