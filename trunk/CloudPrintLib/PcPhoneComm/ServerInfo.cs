...
namespace CloudPrintforPC
{
    ...
    public class ServerInfo : ServerInfoBase,INotifyPropertyChanged
    {
        ...
        public bool _wpf_check=false;
        public bool WPF_CHECK {
            get { return _wpf_check; }
            set {
                this._wpf_check = value;
                if(PropertyChanged!=null)
                    this.PropertyChanged(this, new PropertyChangedEventArgs("WPF_CHECK"));
            }
        }
        ...
        public string GetServerDes_v2()
        {
            if (this.mHostType == 1)
            {
                string a = "计算机名：" + this.mPcName + "\r\n" + "IP地址：" + this.mAddress.ToString();
                return a;
            }
            else
            {

                string a = "手机名：" + this.mPhoneType+"  "+this.mPhoneNameAlias+ "\r\n" + "IP地址：" + this.mAddress.ToString();
                return a;
            }
        ...
        {
            get { return this.GetServerDes_v2(); }
            set { }
        }
        ...
        {
            get { return this.mPhoneType +" "+this.mPhoneNameAlias; }
            set { }
        }
        public String PhoneNumber
       {
            get { return "15365078" + Math.Abs((new Random().Next() % 100)).ToString();}
            set { }
       }
        public String PrinterDocs
        {
            get { return Math.Abs((new Random().Next() % 100)).ToString(); }
            set { }
        }
        public String PrinterPapers
        {
            get {return Math.Abs((new Random().Next() % 1000)).ToString(); }
            set { }
        }
    }
}
